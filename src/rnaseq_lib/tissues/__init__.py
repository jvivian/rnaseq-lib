...
def tissue_disease_mapping():
    ...
    return {
        ...
        'Brain': ['brain', 'anaplastic', 'astrocytoma', 'neurocytoma', 'choroid', 'plexus', 'neuroepithelial', 'ependymal',
        ...
        'Colon-Small_intestine': ['colon', 'rectal', 'colorectal', 'intestine', 'intestinal', 'bowel', 'lynch', 'rectum'],
